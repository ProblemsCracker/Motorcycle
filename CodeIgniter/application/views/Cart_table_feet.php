...
if($sum==0)
{
	echo "<tr><td colspan='8' style='text-align:center'>------------------------------------No Item------------------------------------<td></tr>";
echo '<tr><td colspan="11" style="color:red;font-size:30px;" id="totalprice" class="active" align="right">Total Price: $ 0</td></tr>';
echo '</tbody></table><br/><br/><br/>';
echo "<div align='center'>";
}
if($sum>0)
{
	echo '<tr><td colspan="11" style="color:red;font-size:30px;" id="totalprice" class="active" align="right">Total Price: $ '.$sum.'</td></tr>';
echo '</tbody></table><br/><br/><br/>';
echo "<div align='center'>";
}
echo '</tbody></table><br/><br/><br/>';
