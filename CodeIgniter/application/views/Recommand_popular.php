...
<body>
<ul style="list-style-type:none; text-align:center" id="recommand2">
		<li><h2>Most Popular: </h2></li>
		...
		if(isset($specialPrice2)) 
		{echo "<span style='font-size:24px; color:#F60; text-decoration:line-through'>$".$productPrice."</span><li><span style='color:#F00;font-size:30px; font-weight:bold;'>SALE: $".$specialPrice2."</span></li>";}
		else	
